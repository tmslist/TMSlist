...
4. The VA pays the provider directly. You should not receive a bill.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Community Care extends TMS access for rural veterans. You may qualify if drive time exceeds 60 minutes or wait times are excessive.</li>
    <li>VA research shows 47% of veterans with combat PTSD achieved meaningful improvement. 38% showed concurrent depression remission.</li>
    <li>TMS treatment does not affect your disability rating. Current VA policy separates treatment from compensation evaluation.</li>
  </ul>
</div>
...
For more information, see our guide to [Tms For Ptsd](/blog/tms-for-ptsd/).
For more information, see our guide to [Tms For Veterans Ptsd Military](/blog/tms-for-veterans-ptsd-military/).
For more information, see our guide to [Tms For Veterans Va Coverage](/blog/tms-for-veterans-va-coverage/).
