...
As we covered in our [TMS success rates guide](/blog/tms-success-rates-2026/), completing the full course of TMS is the single biggest predictor of a good outcome. Anything that reduces the treatment's effectiveness works against that goal.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Alcohol makes depression worse and blunts TMS effectiveness. Less drinking means better results.</li>
    <li>If you use alcohol to cope with depression, talk to your treatment team about this.</li>
    <li>Be honest with your provider about your drinking. They need this information for your safety, not to judge you.</li>
  </ul>
</div>
