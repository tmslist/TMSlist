...
| Parameter | OCD TMS | Depression TMS |
|-----------|---------|----------------|
| Brain target | ACC + medial PFC | Left DLPFC |
| Coil | BrainsWay H7 (deep) | Figure-8 or H1 |
| Frequency | 20 Hz | 10 Hz or theta burst |
| Sessions | 29-30 over 6 weeks | 36 over 6-9 weeks |
| Provocation | Yes, before each session | No |
| Session duration | ~20 min + provocation | 19-37 min |
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Concurrent ERP therapy is linked to better long-term maintenance of gains.</li>
    <li>Most major insurers cover deep TMS for OCD with documentation of treatment resistance.</li>
    <li>Ask about H7 coil use, provocation protocol, Y-BOCS tracking, and experience with OCD specifically.</li>
  </ul>
</div>
