...
As we covered in our [does TMS cause memory loss guide](/blog/does-tms-cause-memory-loss/), TMS has no measurable effect on memory or cognitive function. If it does not impair your thinking, it does not impair your driving.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>TMS fits into daily life easily. Many people go during lunch breaks or before work.</li>
    <li>ECT requires someone to drive you home. TMS does not. This is a major practical difference.</li>
    <li>If you feel lightheaded after a session, sit for a few minutes before driving. It passes quickly.</li>
  </ul>
</div>
