...
As we covered in our [TMS during pregnancy guide](/blog/tms-during-pregnancy-safety-data/), the 2025 meta-analysis of 400+ pregnant women found no increase in miscarriage, birth defects, or preterm labor with TMS. The magnetic field is focused on a small area of the scalp and drops off rapidly with distance. The fetus receives no meaningful magnetic exposure. Neither does a breastfeeding infant.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Theta burst stimulation (3-minute sessions) makes treatment feasible with a newborn.</li>
    <li>Most clinics welcome infants in the treatment room. Call ahead to confirm.</li>
    <li>TMS during pregnancy has a smaller but reassuring safety dataset. Discuss risks and benefits with your care team.</li>
  </ul>
</div>
