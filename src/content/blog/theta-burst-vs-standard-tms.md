...
If you are evaluating clinics, ask specifically whether they offer iTBS and which device they use. You can search [TMS providers by location](/us/) and compare what [technologies](/technology/) different clinics use.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Short sessions mean less time commitment, easier scheduling, and potentially lower cost at some clinics.</li>
    <li>Most major TMS devices (BrainsWay, MagVenture, NeuroStar) support theta burst protocols.</li>
    <li>Choose based on practical factors. Clinically, there is no reason to prefer the longer protocol.</li>
  </ul>
</div>
