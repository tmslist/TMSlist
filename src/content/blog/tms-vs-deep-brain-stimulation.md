---
title: "TMS vs. Deep Brain Stimulation: Comparing Brain Stimulation Treatments"
description: "How does TMS compare to deep brain stimulation (DBS) and vagus nerve stimulation (VNS) for treatment-resistant depression? Learn about invasiveness, outcomes, and costs."
publishDate: 2026-04-15
category: research
author: "Dr. Karan Narwal"
image: "/images/blog-covers/tms-vs-deep-brain-stimulation.svg"
tags: ["tms", "dbs", "deep-brain-stimulation", "vns", "treatment-resistant", "comparison"]
---
...
<div class="not-prose my-8 [&_.faq-item]:py-4 [&_.faq-item]:border-b [&_.faq-item]:border-[var(--line)]" itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div class="space-y-4">
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">What is the difference between TMS and DBS?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">TMS is entirely non-invasive — magnetic pulses through the scalp. DBS requires neurosurgery to implant electrodes into deep brain structures. TMS carries minimal risk; DBS carries risks of intracranial hemorrhage, infection, and requires device implantation with battery replacement every 3-5 years.</p>
      </div>
    </div>
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">When is TMS not enough and DBS or VNS needed?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">DBS and VNS are generally reserved for patients who have failed TMS along with multiple medication trials and are suffering from severe, chronic, treatment-resistant illness. The step-wise approach typically involves trying TMS before escalating to device-based neuromodulation.</p>
      </div>
    </div>
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">Is VNS like TMS?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">VNS is partially invasive — it requires chest surgery to implant a device that stimulates the vagus nerve in the neck. It operates through a fundamentally different mechanism than TMS, activating brainstem nuclei that project widely throughout the cortex and limbic system rather than directly targeting specific brain regions.</p>
      </div>
    </div>
  </div>
</div>
