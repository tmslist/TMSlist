---
title: "TMS and Exercise: How Physical Activity Enhances Treatment"
description: "Exercise and TMS share overlapping mechanisms — both trigger neuroplasticity and BDNF release. Research suggests that combining regular exercise with TMS may amplify and extend treatment benefits."
author: "TMS List Editorial Team"
publishDate: 2026-04-18
category: research
tags: ["exercise", "BDNF", "neuroplasticity", "combination therapy", "physical activity"]
image: "/images/blog-covers/tms-and-exercise-physical-activity.svg"
---
...
<div class="not-prose my-8 [&_.faq-item]:py-4 [&_.faq-item]:border-b [&_.faq-item]:border-[var(--line)]" itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div class="space-y-4">
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">Does exercise improve TMS outcomes?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">Yes. A 2017 study found that patients who exercised regularly during a TMS course showed significantly higher remission rates than those who did not — 70% vs. 45%. The exercise did not have to be intense; moderate aerobic activity during the TMS course was sufficient.</p>
      </div>
    </div>
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">Should I exercise before or after TMS sessions?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">Both timing strategies have rationale. Post-exercise BDNF surge peaks 30-60 minutes after exercise and remains elevated for several hours, potentially priming the brain for TMS. Morning exercise before TMS sessions is probably most feasible for most patients.</p>
      </div>
    </div>
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">What type of exercise is best during TMS treatment?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">Aerobic exercise (running, cycling, swimming, brisk walking) has the strongest evidence for mood benefits and BDNF effects. Moderate intensity is sufficient. Resistance training and mind-body exercises like yoga also have evidence supporting mood benefits.</p>
      </div>
    </div>
  </div>
</div>
