---
title: "What Is a TMS Mapping Session? Here's What Actually Happens"
description: "Your first TMS appointment includes motor threshold mapping. Here's what that means, why it matters, and what the clicking and thumb twitching are all about."
...
Before your first real TMS treatment, the technician needs to figure out the right intensity for your brain. That's what the mapping session is -- a calibration step. Every brain is different, and what works for one person might be too strong or too weak for another.
...
You'll sit in a chair that looks like something from a dentist's office. The technician places the TMS coil against the left side of your head, in the area that controls hand movement (the motor cortex). Then they start delivering single magnetic pulses.
...
If you're getting theta burst stimulation (TBS), the mapping process is the same. The only difference is the treatment protocol that follows.
...
It happens occasionally. Some people have a higher motor threshold, which means the technician needs to increase the intensity. In rare cases, the machine's maximum output isn't enough, which can be a limitation for treatment. Certain medications -- particularly benzodiazepines -- can raise your motor threshold, so your provider may ask about what you're taking.
