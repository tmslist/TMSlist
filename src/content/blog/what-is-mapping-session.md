...
As we covered in our [how to prepare for TMS guide](/blog/how-to-prepare-for-tms/), the mapping session is usually done on your first visit, making that appointment longer than subsequent ones.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Mapping takes 15-30 minutes on its own, or up to an hour on your first visit including your first treatment session.</li>
    <li>Most people find mapping mildly uncomfortable but tolerable. It is usually a one-time procedure.</li>
    <li>Some medications (especially benzodiazepines) can raise your motor threshold. Tell your provider what you are taking.</li>
  </ul>
</div>
