...
**Use theta burst stimulation (TBS) if available.** Sessions are about 3 minutes instead of 20-40 minutes, making before-school appointments much easier. As we covered in our [theta burst guide](/blog/theta-burst-vs-standard-tms/), clinical outcomes are equivalent to standard TMS.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Some clinics treat teens as young as 15-16. Find a provider with specific adolescent experience.</li>
    <li>Theta burst (3-minute sessions) makes fitting TMS around school much easier.</li>
    <li>Insurance coverage is harder to get for adolescents due to off-label status. Appeals and out-of-pocket payment are common.</li>
  </ul>
</div>
