...
As we covered in our [mapping session guide](/blog/what-is-mapping-session/), the technician delivers single magnetic pulses while moving the coil across your motor cortex. When your thumb twitches, they have found the right spot. That reference point lets them calculate exactly where to aim for your depression treatment.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>There is no recovery time. You can drive, work, and exercise immediately after each session.</li>
    <li>Mood improvement typically begins around weeks 2-3. Others often notice before you do.</li>
    <li>Completing the full course matters even if you feel better by week 3.</li>
  </ul>
</div>
