---
title: "TMS During Pregnancy: What the Safety Data Actually Shows"
description: "A 2025 meta-analysis of 400+ pregnant patients found no increase in miscarriage, birth defects, or preterm labor with TMS. What ACOG and APA say, and practical considerations."
...
Some women begin TMS in the postpartum period to treat postnatal depression while breastfeeding, avoiding concerns about medication transfer through breast milk. Our [postpartum depression guide](/blog/tms-for-postpartum-depression/) covers this in detail.
...
To understand the different TMS protocols available, visit our [technology guide](/technology/).
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>The risk-benefit calculation compares risk of TMS to risk of untreated depression, which is well-documented and serious.</li>
    <li>First-trimester data is thinner. Most treatment happens in the second or third trimester.</li>
    <li>Ask your provider about their experience with pregnant patients and coordination with your OB-GYN.</li>
  </ul>
</div>
