...
image: "/images/blog-covers/tms-for-eating-disorders.svg"
...
<div class="not-prose my-8 [&_.faq-item]:py-4 [&_.faq-item]:border-b [&_.faq-item]:border-[var(--line)]" itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div class="space-y-4">
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">Which eating disorder responds best to TMS?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">Bulimia nervosa has perhaps the most promising evidence base. A 2021 randomized sham-controlled trial found that 20 sessions of high-frequency left DLPFC TMS produced significant reductions in binge eating and purging behaviors. Binge eating disorder also shows promising results.</p>
      </div>
    </div>
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="font-semibold text-[var(--ink)] mb-2 text-lg" itemprop="name">Can TMS help with the compulsive overvaluation of shape and weight?</h3>
      <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <p class="text-[var(--ink2)]" itemprop="text">Research suggests this may be the mechanism of action. The compulsive overvaluation of shape and weight involves sustained self-referential processing that executive networks normally regulate. DLPFC TMS may enhance this regulatory function, reducing the intensity of compulsive overvaluation and binge/purge urges.</p>
      </div>
    </div>
  </div>
</div>
...
*If you or someone you know is struggling with an eating disorder, contact the National Eating Disorders Association helpline at 1-800-931-2237 for support and resources.*
