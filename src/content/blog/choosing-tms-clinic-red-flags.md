...
As we covered in our [mapping session guide](/blog/what-is-mapping-session/), the mapping session alone takes 30-60 minutes and directly affects whether you receive the right dosage. Skipping this workup is like prescribing glasses without an eye exam.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>High-pressure sales tactics are a red flag. The financial conversation should feel like a consultation.</li>
    <li>Ask about their equipment, protocols, technician experience, and how they coordinate with your other providers.</li>
    <li>Verify credentials on your state medical board website before committing.</li>
  </ul>
</div>
