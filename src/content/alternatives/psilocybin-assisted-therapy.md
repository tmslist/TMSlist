...
description: "Psilocybin therapy is showing breakthrough results in clinical trials for depression and PTSD. Current status, how it works, and comparison with TMS."
fdaApproved: false
approvedFor: "Not FDA-approved. Breakthrough Therapy designation for treatment-resistant depression and MDD."
mechanism: "5-HT2A serotonin receptor agonist — produces profound neuroplasticity, ego dissolution, and emotional processing in 1-2 guided sessions"
typicalCost: "$1,500-$5,000 per guided session (in clinical trials and legal settings)"
sessionDuration: "6-8 hours (full guided session)"
faqs:
  - question: "Is psilocybin therapy legal?"
    answer: "As of 2026, psilocybin therapy is legal in Oregon (regulated service centers), Colorado (moving toward regulated access), and several cities have decriminalized possession. It is NOT yet FDA-approved nationally. Clinical trials are ongoing."
  - question: "How does psilocybin compare to TMS for depression?"
    answer: "Psilocybin may produce rapid, lasting effects in just 1-2 sessions vs 30-36 for TMS. However, psilocybin is not yet FDA-approved, requires extensive psychological support, and isn't appropriate for everyone (psychosis risk). TMS is established, FDA-cleared, and widely available."
  - question: "Can psilocybin therapy make things worse?"
    answer: "Challenging experiences ('bad trips') can occur, which is why supervised, guided sessions with trained therapists are essential. Psilocybin is contraindicated in psychotic disorders (schizophrenia, bipolar with psychotic features)."
  - question: "How many sessions do you need?"
    answer: "Clinical trials typically use 1-2 psilocybin sessions with several preparation and integration therapy sessions. This is dramatically fewer sessions than TMS (30-36) or traditional therapy."
---
...
<div class="not-prose mb-10 grid grid-cols-2 md:grid-cols-4 gap-4">
  <div class="bg-amber-50 border border-amber-100 rounded-xl p-5 text-center">
    <div class="text-2xl font-bold text-amber-700 font-display">Phase III</div>
    <div class="text-xs text-amber-600 mt-1">Clinical trials</div>
  </div>
...
<div class="not-prose my-8 grid grid-cols-1 md:grid-cols-3 gap-4">
  ...
  <div class="bg-amber-50 border border-amber-100 rounded-xl p-5">
    ...
    <p class="text-xs text-amber-700 mb-0">Breakthrough Therapy designation from FDA. Phase III trials by COMPASS Pathways and Usona Institute are ongoing. Possible approval 2025-2027.</p>
  </div>
</div>
...
For more on how TMS compares, read our [TMS vs. Psilocybin guide](/compare/tms-vs-psilocybin/). Use our [clinic finder](/us/) to explore TMS providers available today.
