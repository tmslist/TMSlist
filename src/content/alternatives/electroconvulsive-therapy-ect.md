...
description: "ECT remains the gold standard for severe depression with the highest remission rates — but requires anesthesia. How it compares to TMS."
fdaApproved: true
approvedFor: "Severe depression, treatment-resistant depression, catatonia, mania, schizophrenia"
mechanism: "Controlled electrical stimulation inducing brief seizure under anesthesia — triggers widespread neurochemical and neuroplastic changes"
typicalCost: "$800-$2,500 per session"
sessionDuration: "5-10 minutes (procedure) + 1-2 hours recovery"
faqs:
  - question: "Does ECT cause memory loss?"
    answer: "Yes, memory effects are ECT's most significant side effect. Most patients experience temporary memory difficulties around the time of treatment. Some have longer-lasting gaps. Unilateral electrode placement and ultrabrief pulse width reduce this risk."
  - question: "Is ECT still used? Isn't it outdated?"
    answer: "ECT is very much still used and remains the most effective treatment for severe depression. Modern ECT bears little resemblance to historical depictions. It's performed under general anesthesia with muscle relaxants — patients feel nothing."
  - question: "How does ECT compare to TMS?"
    answer: "ECT has higher remission rates (50-70% vs 30-35% for TMS) but requires anesthesia, causes memory effects, and needs more recovery time. TMS is preferred for most treatment-resistant cases; ECT is reserved for severe or life-threatening situations."
  - question: "How many ECT sessions do I need?"
    answer: "Typically 6-12 acute treatments (3 per week for 2-4 weeks), followed by maintenance sessions tapering from weekly to monthly."
---
...
<div class="not-prose my-8 grid grid-cols-1 md:grid-cols-3 gap-4">
  <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-5">
    <div class="flex items-center gap-2 mb-2">
      ...
      <h4 class="font-semibold text-emerald-900 text-sm m-0">Severe Depression</h4>
    </div>
...
<div class="not-prose my-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
  <h4 class="font-semibold text-amber-800 text-sm mb-2">Minimizing memory effects</h4>
  <p class="text-sm text-amber-700 mb-0"><strong>Unilateral electrode placement</strong> (right side only) and <strong>ultrabrief pulse width</strong> significantly reduce memory side effects compared to bilateral/standard pulse ECT. Ask your provider about these modern techniques.</p>
</div>
