...
description: "SGB is an anesthetic injection showing promise for PTSD — rapid symptom relief through the sympathetic nervous system. How it compares to TMS."
fdaApproved: false
approvedFor: "FDA-cleared for pain management. Off-label for PTSD, anxiety, hot flashes."
mechanism: "Local anesthetic injection near the stellate ganglion in the neck — 'reboots' the overactive fight-or-flight response"
typicalCost: "$1,500-$3,000 per injection"
sessionDuration: "15-30 minutes (procedure) + 30-60 minutes recovery"
faqs:
  - question: "How fast does SGB work for PTSD?"
    answer: "Many patients report improvement within hours to days. Some describe it as a 'switch being flipped' — the constant hypervigilance and anxiety suddenly quiet. However, not everyone responds."
  - question: "Is SGB safe?"
    answer: "SGB has been used safely in pain management for decades. Risks include temporary hoarseness, difficulty swallowing, drooping eyelid (Horner's syndrome), and rare but serious complications like seizure or pneumothorax."
  - question: "How many injections do I need?"
    answer: "Typically 1-2 injections. Some patients need a second injection on the opposite side. Unlike TMS (30-36 sessions), SGB requires very few treatments."
  - question: "How does SGB compare to TMS for PTSD?"
    answer: "SGB works faster (hours vs weeks) with fewer visits. TMS has a stronger evidence base, targets brain circuits directly, and may produce more durable effects. SGB targets the peripheral nervous system, not the brain."
---
...
<div class="not-prose mb-10 grid grid-cols-2 md:grid-cols-4 gap-4">
  ...
  <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-5 text-center">
    ...
    <div class="text-xs text-emerald-600 mt-1">Onset of relief</div>
  </div>
...
Many experts suggest these treatments may work well **in combination** — SGB for rapid hyperarousal relief, followed by TMS for sustained brain circuit normalization. Use our [provider directory](/us/) to find TMS clinics, and ask about SGB availability at pain management centers in your area.
