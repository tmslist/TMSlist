...
description: "IV ketamine for rapid depression relief — how it works, what it costs, safety profile, and how it compares to TMS therapy."
fdaApproved: false
approvedFor: "Off-label for treatment-resistant depression, PTSD, chronic pain, suicidal ideation"
mechanism: "NMDA receptor antagonist — rapidly increases glutamate, BDNF, and synaptogenesis"
typicalCost: "$400-$800 per infusion"
sessionDuration: "40-60 minutes infusion + 30-60 minutes recovery"
faqs:
  - question: "How fast does ketamine work for depression?"
    answer: "Many patients notice improvement within hours of the first infusion. Effects peak at 24-72 hours. However, a single infusion's effects typically last only 1-3 weeks without follow-up sessions."
  - question: "Is ketamine therapy legal?"
    answer: "Yes. Ketamine is an FDA-approved anesthetic. Its use for depression is off-label but legal when administered by a licensed provider. It's widely available at specialty clinics across the US."
  - question: "Is ketamine addictive?"
    answer: "Ketamine has abuse potential. In clinical settings with controlled dosing, addiction risk is considered low. However, patients with active substance use disorders should discuss risks carefully with their provider."
  - question: "How does ketamine compare to TMS?"
    answer: "Ketamine works faster (hours vs weeks) but effects are shorter-lived. TMS produces more durable results after a treatment course. Ketamine has dissociation and abuse potential; TMS has neither."
---
...
<div class="not-prose mb-10 grid grid-cols-2 md:grid-cols-4 gap-4">
  ...
  <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-5 text-center">
    ...
    <div class="text-xs text-emerald-600 mt-1">Onset of action</div>
  </div>
...
<div class="not-prose my-6 bg-red-50 border border-red-200 rounded-xl p-5">
  <h4 class="font-semibold text-red-800 text-sm mb-2">Who should NOT use ketamine</h4>
  <ul class="text-sm text-red-700 space-y-1 mb-0 list-disc pl-4">
    ...
    <li>Active substance use disorder (especially ketamine or PCP)</li>
    <li>Pregnancy</li>
...
For a detailed breakdown, read our [TMS vs. Ketamine comparison](/compare/tms-vs-ketamine/). Use our [clinic finder](/us/) to find providers offering both options.
