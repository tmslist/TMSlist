---
title: "Deep TMS for OCD: My Experience with the BrainsWay Protocol"
description: "Jessica, a 28-year-old graphic designer from Chicago, shares how Deep TMS reduced her severe OCD symptoms by 70% after years of only partial relief from SSRIs and CBT."
author: "TMS List Editorial Team"
publishDate: 2026-03-14
category: stories
tags: ["patient story", "OCD", "deep TMS", "BrainsWay"]
...
Her first psychiatrist put her on fluvoxamine, an SSRI commonly prescribed for [OCD](/treatments/ocd/). It helped — maybe a 30% reduction in symptoms. Enough to function, not enough to feel free. She added cognitive behavioral therapy with exposure and response prevention (ERP). That brought another 15-20% improvement.
...
Early 2025. Jessica's ERP therapist brought up the fact that the FDA had cleared a [Deep TMS protocol specifically for OCD](/technology/brainsway-deep-tms/). Unlike standard TMS, which targets the brain's surface, Deep TMS uses an H-coil helmet that reaches deeper structures — the anterior cingulate cortex and medial prefrontal cortex, areas wired into OCD circuitry.

Jessica spent a month researching. Clinical trial data. Patient forums. Everything she could find about [how Deep TMS differs from standard rTMS](/technology/dtms-vs-rtms/).
...
She found a clinic in Chicago with the [BrainsWay Deep TMS](/technology/brainsway-deep-tms/) system and the OCD-specific H7 coil. The protocol was different from depression TMS in one key way: each session included a provocation component.
...
She continues on a reduced dose of fluvoxamine and monthly ERP maintenance sessions. Her psychiatrist discussed [maintenance TMS](/treatments/) as an option if symptoms creep back. So far — ten months out — they haven't.
...
She started a small online community for people with OCD exploring [TMS as a treatment option](/treatments/ocd/). She's careful not to overpromise — Deep TMS doesn't work for everyone, and the OCD protocol is newer and less studied than the depression protocol. But she believes in sharing what worked.
...
- **Find a clinic with the OCD-specific H7 coil.** Not all TMS clinics offer the [BrainsWay OCD protocol](/technology/brainsway-deep-tms/). Standard figure-8 coils are not FDA-cleared for OCD.
