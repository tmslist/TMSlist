...
1. **Pre-treatment MRI:** You get a structural (and sometimes functional) brain MRI
2. **Target identification:** Your clinician locates the optimal DLPFC target on your actual brain scan
3. **Registration:** The system builds a 3D model of your head and brain
4. **Real-time tracking:** During treatment, cameras or sensors track both the coil and your head position
5. **Live feedback:** The system shows coil position relative to the brain target in real-time, allowing precise adjustment throughout each session
