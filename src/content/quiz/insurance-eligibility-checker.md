---
title: "TMS Insurance Eligibility Checker"
description: "Find out if your insurance covers TMS therapy — check eligibility requirements, understand prior authorization, and estimate your out-of-pocket costs."
---
...
1. **Read the denial letter carefully** — it will state the specific reason
2. **Request a peer-to-peer review** — your psychiatrist calls the insurance company's medical director to make the case directly
3. **File a formal appeal** — include additional documentation that addresses the denial reason
4. **External review** — if internal appeals fail, most states allow independent external review
5. **Contact your state insurance commissioner** — if you believe the denial violates state coverage mandates
