---
title: "TMS vs Spravato: Magnetic Stimulation vs Rapid-Acting Pharmacology"
description: "Comparing TMS therapy and Spravato nasal spray for treatment-resistant depression — how they work, session requirements, insurance coverage, and outcomes."
image: "/images/brain_stimulation_art_1769446474392.jpg"
treatmentA: "TMS"
treatmentB: "Esketamine (Spravato)"
...
faqs:
  - question: "Which is easier to access?"
    answer: "TMS is more widely available. Spravato requires REMS-certified clinics and 2-hour monitoring after each dose due to dissociation risk."
  - question: "Can I do both?"
    answer: "Absolutely. Some people try TMS first and add or switch to Spravato if the response isn't enough. Others start with Spravato for rapid relief and then do TMS for longer-term stability."
---
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    <li>TMS is time-limited (6-9 weeks); Spravato requires ongoing maintenance</li>
    <li>Spravato works faster (days) than TMS (weeks)</li>
    <li>TMS requires no sedation; Spravato causes dissociation requiring monitoring</li>
    <li>Both are FDA-approved and insurance-covered for TRD</li>
    <li>Some patients benefit from combining both treatments</li>
  </ul>
</div>
