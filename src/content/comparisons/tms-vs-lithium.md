...
faqs:
  - question: "Can lithium reduce suicide risk?"
    answer: "Yes — lithium is the only psychiatric medication with strong evidence for reducing suicide risk independent of its antidepressant effect. This is a significant consideration for patients with suicidal ideation."
---
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>TMS effects last 6-12 months; lithium is taken indefinitely</li>
    <li>Both are evidence-based options for treatment-resistant depression</li>
  </ul>
</div>
