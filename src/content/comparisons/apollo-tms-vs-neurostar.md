---
title: "Apollo TMS vs NeuroStar: Market Leader vs New Entrant"
description: "How does NeuroStar, the most widely-installed TMS system in the US, compare to Apollo TMS — a newer US-based company? Coverage, availability, and clinical credibility."
author: "TMS List Editorial Team"
publishDate: 2026-03-10
treatmentA: "Apollo TMS"
treatmentB: "NeuroStar"
image: "/images/brain_stimulation_art_1769446474392.jpg"
verdict: "NeuroStar has the largest US install base, most clinical trial data, and deepest insurance relationships. Apollo TMS is a newer company bringing competition to the market but with a smaller commercial footprint."
verdictWinner: "neurostar"
faqs: []
---

Apollo TMS is a newer entrant in the US TMS market. NeuroStar has been the dominant system since its 2008 FDA clearance. Comparing them means weighing market maturity against fresh competition — and what that means for availability and insurance coverage.
...
**Apollo TMS** is built around a figure-8 coil design, purpose-built for the US market. As a newer company, Apollo focused on building a modern system that meets current clinical standards. The platform supports standard protocols and theta burst stimulation.
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>Apollo TMS is a newer entrant with a growing US presence</li>
    <li>Both support equivalent clinical protocols (theta burst, standard rTMS)</li>
    <li>NeuroStar has deeper insurance relationships and easier coverage</li>
    <li>Apollo is a valid option if available and covered by your plan</li>
  </ul>
</div>

<div class="not-prose my-10 bg-[var(--ink)] rounded-2xl p-8 text-center">
  <h3 class="text-2xl font-semibold text-white mb-3">Find a TMS Clinic</h3>
  <p class="text-[var(--muted)] mb-6 max-w-lg mx-auto">Browse verified TMS providers by device, location, and insurance coverage.</p>
