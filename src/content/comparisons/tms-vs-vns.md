...
faqs:
  - question: "How are TMS and VNS different?"
    answer: "TMS is non-invasive (external coil). VNS requires surgical implantation of a device. TMS works faster (weeks vs months for VNS). VNS is typically reserved for the most treatment-resistant cases."
---
...
<div class="not-prose my-8 bg-[rgba(201,101,74,0.06)] border border-[var(--line)] rounded-2xl p-6">
  ...
  <ul class="space-y-2 text-sm text-[var(--warm)]">
    ...
    <li>TMS comes first in the treatment pathway for nearly all patients</li>
    <li>VNS is reserved for highly treatment-resistant cases</li>
  </ul>
</div>
