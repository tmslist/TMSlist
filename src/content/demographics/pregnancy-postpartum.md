---
title: "TMS During Pregnancy & Postpartum"
description: "TMS therapy during pregnancy and postpartum — safety data, why it's a compelling medication-free option, and what expecting and new mothers should know."
---
...
<div class="not-prose my-8 bg-gradient-to-r from-[var(--warm)] to-[var(--ink)] border border-white/10 rounded-2xl p-8 shadow-lg shadow-[rgba(10,22,40,0.15)]">
  <div class="flex items-start gap-4">
    ...
    <div>
      ...
      <p class="text-white leading-relaxed font-medium">10–20% of women experience perinatal depression. TMS offers a medication-free path — no drug crosses the placenta, none enters breast milk.</p>
    </div>
  </div>
</div>
