---
title: "LGBTQ+ Friendly TMS Providers"
description: "Finding LGBTQ+ affirming TMS therapy — why inclusive care matters, what to look for in a provider, and addressing unique mental health needs."
---
...
<div class="not-prose my-8 bg-gradient-to-r from-[var(--warm)] to-[var(--ink)] border border-white/10 rounded-2xl p-8 shadow-lg shadow-[rgba(10,22,40,0.15)]">
  <div class="flex items-start gap-4">
    ...
    <div>
      <p class="text-xs font-bold text-white/80 uppercase tracking-wider mb-1">Key Fact</p>
      <p class="text-white leading-relaxed font-medium">LGBTQ+ individuals experience depression at 2–3x the rate of the general population. Finding an affirming provider isn't just about comfort — it's about getting appropriate, effective care.</p>
    </div>
  </div>
</div>
