---
title: "TMS for College Students"
description: "TMS therapy for college and graduate students with depression — campus resources, scheduling around classes, insurance options, and what students should know."
---
...
<div class="not-prose my-8 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 rounded-2xl p-8">
  <div class="flex items-start gap-4">
    <div class="shrink-0 w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center">
