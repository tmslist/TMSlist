...
insurer: "Medi-Cal (California Medicaid)"
description: "Medi-Cal coverage for TMS therapy in California — managed care plan differences, authorization requirements, and finding Medi-Cal TMS providers."
...
Medi-Cal delivers mental health benefits through two pathways:
...
- For severe, persistent mental illness
- Accessed through county mental health departments
- TMS may be available at county-contracted providers

## Eligibility requirements

Most Medi-Cal managed care plans require:

1. **MDD diagnosis** by a psychiatrist
2. **2+ medication failures** at adequate doses for adequate duration
3. **Prior authorization** from your managed care plan
4. **In-network provider** — must use a TMS clinic that accepts your specific Medi-Cal plan
