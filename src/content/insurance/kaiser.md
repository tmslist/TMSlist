...
description: "Kaiser Permanente TMS therapy coverage — how Kaiser's integrated model handles TMS referrals, costs, and the in-network process."
image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop"
typicalCost: "$500-$1,500"
faqs:
  - question: "Does Kaiser offer TMS?"
    answer: "Yes, though availability varies by region. Kaiser may provide TMS through their own facilities or refer to contracted providers. Internal referral from your Kaiser psychiatrist is typically needed."
---
...
<div class="not-prose mb-10 grid grid-cols-1 md:grid-cols-3 gap-4">
  ...
  <div class="bg-blue-50 border border-blue-100 rounded-xl p-5 text-center">
    <div class="text-2xl font-bold text-blue-700 font-display">$500-$1,500</div>
...
1. **Start with your Kaiser psychiatrist.** You need to be seeing a Kaiser behavioral health provider who documents your treatment-resistant depression
2. **Internal referral.** Your psychiatrist submits an internal referral for TMS evaluation
3. **TMS evaluation.** You meet with Kaiser's TMS team (where available) for assessment
4. **Authorization.** Kaiser reviews it internally — no phone calls to an outside insurance company
5. **Treatment.** Sessions happen at a Kaiser medical center or contracted facility
