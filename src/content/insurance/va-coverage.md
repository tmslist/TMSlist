---
title: "VA TMS Coverage for Veterans"
insurer: "Veterans Affairs (VA)"
description: "How the VA covers TMS therapy for veterans — eligibility, VA medical centers offering TMS, and navigating the VA system for brain stimulation treatment."
...
1. **Are enrolled in VA healthcare** (any priority group)
2. **Have treatment-resistant depression** documented by a VA psychiatrist
3. **Have failed adequate medication trials** (typically 2+, documented in your VA medical records)
4. **Are evaluated by the VA TMS program** at a participating medical center
...
1. **Talk to your VA psychiatrist** about your interest in TMS
2. **Internal referral** to the VA TMS program (may require travel to a VA that has TMS)
3. **TMS evaluation** by the program team
4. **Treatment:** Standard 36-session protocol at the VA facility
5. **Follow-up:** VA mental health team monitors how you respond
...
## VA TMS Coverage: What You Need to Know
