---
title: "Accelerated TMS Protocols: SAINT, SNT, and the Future of Rapid Treatment"
description: "Research on accelerated and intensive TMS protocols — the Stanford SAINT trial, multi-session-per-day approaches, safety data, and whether faster treatment is also better treatment."
author: "TMS List Editorial Team"
publishDate: 2026-03-01
category: research
tags: ["accelerated TMS", "SAINT", "Stanford", "theta burst", "intensive protocols", "SNT"]
---

## The problem with six weeks of daily treatment

Standard TMS protocols for depression require 30-36 sessions delivered once daily, five days a week, over six to seven weeks. The treatment works — [response rates of 50-60%](/research/tms-depression-meta-analysis/) are well documented — but the time commitment is a genuine barrier.

Six weeks of daily clinic visits means rearranging work schedules, arranging childcare, managing transportation, and committing to a routine that a lot of people find logistically difficult. If you're traveling from a rural area to reach a [TMS provider](/us/), the burden is even greater. Some people who would benefit from TMS never start. Others begin treatment but drop out before completing the full course, compromising their outcomes.
...
Building on the THREE-D trial's validation of [theta burst stimulation](/technology/) as equivalent to standard rTMS, several groups have tested three iTBS sessions per day with 15-minute to one-hour intervals between sessions. These protocols can deliver a full treatment course in about two weeks. Early results are promising, with response and remission rates comparable to or slightly higher than standard once-daily approaches.
...
**Cognitive effects:** Formal neuropsychological testing in the SAINT trials showed no cognitive impairment — consistent with the broader [TMS vs ECT evidence](/research/tms-vs-ect-evidence/) showing that TMS doesn't hurt cognition. Some people actually showed cognitive improvement, likely because their mood was better.
...
**Higher total dose.** The SAINT protocol delivers 90,000 total pulses over five days. Standard protocols deliver 54,000-108,000 pulses over six weeks. The concentrated delivery may produce stronger [neuroplastic effects](/research/neuroplasticity-and-tms/) than the same dose spread over a longer period.
...
**The infrastructure caveat:** Running SAINT-level protocols requires fMRI capability for targeting, neuronavigation equipment, and staff willing to manage 10-session treatment days. Not every clinic can — or should — offer this level of intensity. [Finding a clinic](/us/) with the right equipment and experience matters.
...
Accelerated TMS is moving from research innovation to clinical reality. Several [TMS technology companies](/technology/) are developing commercial systems optimized for accelerated delivery, including integrated neuronavigation and automated targeting.

Large multi-site replication trials for the SAINT protocol are underway, and results are expected to inform potential new [FDA clearance](/research/fda-clearance-history/) pathways specifically for accelerated approaches. If the efficacy and safety data hold up at scale, accelerated TMS could become the default protocol within a few years — making the current six-week standard a relic of an earlier era.
...
To find out whether accelerated TMS is available near you, browse our [provider directory](/us/) or connect with a [TMS specialist](/specialists/) who stays current with the latest research.
