---
title: "TMS vs ECT: What the Comparative Research Shows"
description: "Head-to-head evidence comparing transcranial magnetic stimulation and electroconvulsive therapy — efficacy, side effects, cognitive impact, cost, and when each treatment is appropriate."
author: "TMS List Editorial Team"
publishDate: 2026-03-01
category: research
tags: ["ECT", "comparison", "efficacy", "side effects", "cognitive effects", "cost"]
---
...
The TMS side effect profile is comparable to a mild headache. The ECT side effect profile involves general anesthesia, seizure induction, and cognitive consequences. For [treatment guides](/treatments/) on managing TMS side effects, see our patient resources.
...
Insurance coverage for both treatments has improved significantly. Most major insurers cover TMS for treatment-resistant depression following [FDA clearance](/research/fda-clearance-history/), though prior authorization requirements and definitions of "treatment resistance" vary.
...
To discuss your options with an experienced provider, find a [TMS specialist](/specialists/) or browse our [state-by-state directory](/us/) for clinics in your area.
