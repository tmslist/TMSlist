      ...
      {tags.map((tag, i) => (
        ...
        >
          ...
          <button
            type="button"
            onClick={() => removeTag(i)}
            className="text-[var(--ink2)] hover:text-[var(--ink)] transition-colors"
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-20">
        <div className="w-8 h-8 border-2 border-[rgba(10,22,40,0.2)] border-t-[#0A1628] rounded-full animate-spin" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-[var(--ink)]">{clinic.name || 'New Clinic'}</h2>
          <p className="text-sm text-[var(--muted)] mt-0.5">ID: {clinic.id}</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
          className="px-6 py-2.5 bg-[var(--ink)] hover:bg-[var(--ink)] text-white text-sm font-semibold rounded-lg transition-colors disabled:opacity-50 flex items-center gap-2"
        >
          {saving && (
      ...
      <div className="bg-white rounded-xl border border-[var(--line)] shadow-sm p-6">
        ...
        {activeTab === 'basic' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Basic Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-[var(--line)] rounded-lg text-sm focus:border-[var(--ink2)] focus:ring-1 focus:ring-[rgba(10,22,40,0.15)]"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Provider Type</label>
              <select
                value={clinic.providerType}
                onChange={(e) => updateField('providerType', e.target.value)}
                className="w-full px-3 py-2.5 border border-[var(--line)] rounded-lg text-sm focus:border-[var(--ink2)] focus:ring-1 focus:ring-[rgba(10,22,40,0.15)] bg-white"
              >
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Long Description</label>
              <textarea
        ...
        {activeTab === 'location' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Location</h3>
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--ink2)] mb-1">ZIP Code</label>
                <input
                  type="text"
                  value={clinic.zip}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div>
                <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Country</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Latitude</label>
                <input
                  type="number"
                  step="any"
                  value={clinic.lat ?? ''}
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Longitude</label>
                <input
                  type="number"
                  step="any"
                  value={clinic.lng ?? ''}
        ...
        {activeTab === 'contact' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Contact Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
        ...
        {activeTab === 'services' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Services &amp; Equipment</h3>
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">TMS Machines</label>
              <TagInput
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Insurance Accepted</label>
              <TagInput
        ...
        {activeTab === 'hours' && (
          <div className="space-y-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold text-[var(--ink)]">Opening Hours</h3>
              <button
                type="button"
                onClick={addHour}
                className="px-3 py-1.5 bg-[var(--ink)] hover:bg-[var(--ink)] text-white text-xs font-medium rounded-lg transition-colors"
              >
                + Add Hours
              </button>
            </div>
            {clinic.openingHours.length === 0 ? (
              <p className="text-sm text-[var(--muted)] text-center py-6">No hours set. Click "Add Hours" to begin.</p>
            ) : (
              <div className="space-y-3">
                {clinic.openingHours.map((h, i) => (
                  <div key={i} className="flex items-center gap-3 bg-[var(--paper2)] rounded-lg p-3">
                    <select
                      value={h.day}
                      onChange={(e) => updateHour(i, 'day', e.target.value)}
                      className="px-3 py-2 border border-[var(--line)] rounded-lg text-sm bg-white focus:border-[var(--ink2)]"
                    >
                      {DAYS_OF_WEEK.map((d) => (
                    ...
                    <input
                      ...
                      className="px-3 py-2 border border-[var(--line)] rounded-lg text-sm focus:border-[var(--ink2)]"
                    />
        ...
        {activeTab === 'media' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Media</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Hero Image URL</label>
                <input
                  type="url"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm font-medium text-[var(--ink2)]">Gallery URLs</label>
                <button
                  type="button"
              ...
              {(clinic.media.gallery_urls || []).length === 0 ? (
                <p className="text-sm text-[var(--muted)] text-center py-4">No gallery images.</p>
              ) : (
        ...
        {activeTab === 'google' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Google Profile</h3>
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Place ID</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Google Maps Embed URL</label>
              <input
                type="url"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Google Reviews URL</label>
              <input
                type="url"
        ...
        {activeTab === 'pricing' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Pricing</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 border border-[var(--line)] rounded-lg text-sm bg-white focus:border-[var(--ink2)]"
                >
        ...
        {activeTab === 'accessibility' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Accessibility &amp; Inclusivity</h3>
            ...
            <div className="pt-2">
              <label className="block text-sm font-medium text-[var(--ink2)] mb-1">Languages Spoken</label>
              <TagInput
        ...
        {activeTab === 'availability' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Availability</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <Toggle
        ...
        {activeTab === 'faqs' && (
          <div className="space-y-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold text-[var(--ink)]">FAQs</h3>
              <button
                type="button"
                onClick={addFaq}
                className="px-3 py-1.5 bg-[var(--ink)] hover:bg-[var(--ink)] text-white text-xs font-medium rounded-lg transition-colors"
            ...
            {clinic.faqs.length === 0 ? (
              <p className="text-sm text-[var(--muted)] text-center py-6">No FAQs. Click "Add FAQ" to create one.</p>
            ) : (
              <div className="space-y-4">
                {clinic.faqs.map((faq, i) => (
                  <div key={i} className="bg-[var(--paper2)] rounded-lg p-4 space-y-3">
                    <div className="flex items-start justify-between gap-2">
                      <span className="text-xs font-semibold text-[var(--muted)] mt-2">Q{i + 1}</span>
                      <button
                        type="button"
                        onClick={() => removeFaq(i)}
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-[var(--line)] rounded-lg text-sm focus:border-[var(--ink2)]"
        ...
        {activeTab === 'status' && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-[var(--ink)] mb-4">Status &amp; Visibility</h3>
            <div className="space-y-4">
              <Toggle
            ...
            <div className="mt-6 p-4 bg-[var(--paper2)] rounded-lg text-sm text-[var(--muted)]">
              <p><span className="font-medium text-[var(--ink2)]">Verified</span> clinics appear with a badge and are prioritized in search results.</p>
              <p className="mt-1"><span className="font-medium text-[var(--ink2)]">Featured</span> clinics are highlighted on the homepage and city pages.</p>
            </div>
          </div>
        )}
      </div>
