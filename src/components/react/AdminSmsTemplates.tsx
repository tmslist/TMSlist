...
function CharacterCount({ count }: { count: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className={`text-[11px] font-medium ${isOver ? 'text-red-600' : 'text-[var(--muted)]'}`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-[var(--ink)]">SMS Templates</h2>
        ...
        <div className="bg-white rounded-xl border border-[rgba(10,22,40,0.15)] shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-medium text-[var(--ink2)] mb-1">Carrier Routing</label>
                <select
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="block text-xs font-medium text-[var(--ink2)]">Message Body *</label>
                <span className="text-[11px] text-[var(--muted)]">Supports {{variables}}</span>
              </div>
              <textarea
                value={editing.body}
            ...
            {editing.body && (
              <div className="bg-[var(--paper2)] border border-[var(--line)] rounded-lg p-4">
                <p className="text-[11px] font-semibold text-[var(--muted)] uppercase mb-2">Preview</p>
                <p className="text-sm text-[var(--ink2)]">{editing.body}</p>
              </div>
            )}
          </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-[var(--line)] p-12 text-center">
          ...
          <h4 className="text-sm font-medium text-[var(--ink2)] mb-1">No SMS templates yet</h4>
          <p className="text-sm text-[var(--muted)]">Create your first SMS template.</p>
        ...
        <div className="bg-white rounded-xl border border-[var(--line)] overflow-hidden">
          <div className="divide-y divide-[var(--line)]">
            {filtered.map((t) => (
              <div key={t.id} className="flex items-start gap-4 px-5 py-4 hover:bg-[var(--paper2)] transition-colors">
                <div className="flex-1 min-w-0">
                  ...
                  <h4 className="text-sm font-semibold text-[var(--ink)] mb-1">{t.name}</h4>
                  <p className="text-xs text-[var(--ink2)] mb-2">{t.body}</p>
