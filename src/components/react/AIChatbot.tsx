...
export default function AIChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm the TMS List Treatment Advisor. I can help you understand TMS therapy, check if you might be a candidate, and answer questions about cost and insurance. What would you like to know?",
    },
  ]);
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      setMessages([...newMessages, { role: 'assistant', content: data.message || 'Sorry, I could not generate a response.' }]);
    } catch {
