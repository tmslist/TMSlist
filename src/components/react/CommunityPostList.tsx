      ...
      <div className="mb-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-[var(--line)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[rgba(10,22,40,0.15)] focus:border-transparent placeholder-[var(--muted)]"
          />
          {searchQuery && (
            <button
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
                sort === opt.key
                  ...
                  : 'text-[var(--muted)] hover:text-[var(--ink2)] hover:bg-[var(--paper2)]'
              }`}
            >
              {opt.label}
            </button>
      ...
      <div className="space-y-3">
        {posts.length === 0 && !loading && (
          <div className="text-center py-12 bg-white rounded-xl border border-[var(--line)]">
            <svg className="w-10 h-10 text-[var(--line)] mx-auto mb-3" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      {hasMore && (
        <div className="text-center mt-6">
          <button
            ...
            disabled={loading}
            className="px-6 py-2.5 bg-white border border-[var(--line)] rounded-lg text-sm font-medium text-[var(--ink2)] hover:bg-[var(--paper2)] hover:border-[rgba(10,22,40,0.15)] transition-all disabled:opacity-50"
          >
