    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="w-full max-w-md rounded-2xl shadow-2xl p-8" style={cardStyle}>
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl text-sm font-semibold text-[var(--ink2)] border border-[var(--line)] hover:bg-[var(--paper2)] transition-all mb-4"
