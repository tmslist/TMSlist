...
const ALL_BADGES: Badge[] = [
  ...
  { id: 'hundred-pulses', name: '100 Pulses', description: 'Fired 100 pulses in one session', emoji: '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="text-[var(--ink2)]"><text x="2" y="16" font-size="14" font-weight="bold">100</text></svg>', earned: false },
  ...
  { id: 'all-protocols', name: 'Protocol Explorer', description: 'Tested all 6 clinical protocols', emoji: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-[var(--warm)]"><path stroke-linecap="round" stroke-linejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0121 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg>', earned: false },
  { id: 'deep-tms', name: 'Deep Reach', description: 'Activated Deep TMS protocol', emoji: '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="text-[var(--warm)]"><path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/></svg>', earned: false },
  ...
  { id: 'motor-cortex', name: 'Motor Mapping', description: 'Targeted the motor cortex region', emoji: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-[var(--ink2)]"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25v-3.435a2.652 2.652 0 00-.75-1.851l-2.94-2.94a2.652 2.652 0 00-1.851-.75L15 9m0 0l-3.5 3.5m-4.5 4.5L9 15m3.5-4.5l4.5-4.5"/></svg>', earned: false },
];
